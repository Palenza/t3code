...
export const TRANSCRIPTION_START_SESSION_CHANNEL = "desktop:transcription-start-session";
export const TRANSCRIPTION_SEND_AUDIO_CHANNEL = "desktop:transcription-send-audio";
export const TRANSCRIPTION_STOP_SESSION_CHANNEL = "desktop:transcription-stop-session";
export const TRANSCRIPTION_CANCEL_SESSION_CHANNEL = "desktop:transcription-cancel-session";
export const TRANSCRIPTION_UPDATE_CHANNEL = "desktop:transcription-update";
export const TRANSCRIPTION_ERROR_CHANNEL = "desktop:transcription-error";
export const VOICE_MODELS_GET_CATALOG_CHANNEL = "desktop:voice-models-get-catalog";
export const VOICE_MODELS_GET_DOWNLOAD_STATES_CHANNEL = "desktop:voice-models-get-download-states";
export const VOICE_MODELS_DOWNLOAD_CHANNEL = "desktop:voice-models-download";
export const VOICE_MODELS_PAUSE_DOWNLOAD_CHANNEL = "desktop:voice-models-pause-download";
