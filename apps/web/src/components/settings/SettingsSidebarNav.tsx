...
> = {
  ...
  "/settings/tableau-local": GaugeIcon,
  ...
  return (
    <>
      <SidebarContent className="overflow-x-hidden">
        {/* `pt-8` conservé à la reprise de l'amont : le bandeau griffé occupe le
            haut de la colonne et, sans ce retrait, « General » lui rentre dedans
            (reproche fondateur 29/07). Leur mise en page ne le prévoit pas. */}
        <SidebarGroup className="gap-2 p-[var(--sidebar-content-inset)] pt-8">
