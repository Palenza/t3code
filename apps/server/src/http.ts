...
// EXPORTÉ chez nous : tableauLocalProxy et rangerFils s'en servent pour la
// garde d'origine. Le garder public ne coûte rien à l'amont.
export const DESKTOP_RENDERER_ORIGINS = ["t3code://app", "t3code-dev://app"];
