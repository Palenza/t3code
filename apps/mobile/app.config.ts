    ...
    widgets: [
      {
        ...
        description: "Shows the current state of active Raptor agents.",
...
const config: ExpoConfig = {
  ...
  ios: {
    ...
    infoPlist: {
      ...
      NSLocalNetworkUsageDescription:
        "Allow Raptor to connect to Raptor servers on your local network or tailnet.",
      NSMicrophoneUsageDescription: "Allow Raptor to capture speech for voice dictation.",
  ...
  plugins: [
    ...
    [
      "expo-camera",
      {
        cameraPermission: "Allow Raptor to access your camera so you can scan pairing QR codes.",
